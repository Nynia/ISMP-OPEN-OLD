...
public class SpQueryServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		.append(" AND u.cp_id=o.cp_id and u.cp_id= ? and o.orderstring_type<>3 GROUP BY o.cp_id ")
		.toString();
		List<Map<String,Object>> queryResultList=jdbcTemplate.queryForList(sql,time1,time2,cpId);
