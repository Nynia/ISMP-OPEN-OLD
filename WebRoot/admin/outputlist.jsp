  ...
  <script>
	...
	//1.CP，2.linkid 3.订购时间,4.手机号，5.手机号+时间
		...
		if($.trim(userid)==""&&start==""&&end==""&&$.trim(linkid)==""){
			window.self.location.href="queryoutput";
		}
		if($.trim(linkid)!=""){
			window.self.location.href="queryoutput?type=2&linkid="+linkid;
		}
		if($.trim(userid)!=""&&start==""&&end==""){
			window.self.location.href="queryoutput?type=4&userid="+userid;
		}
		
		if($.trim(userid)==""&&start!=""&&end!=""){
			window.self.location.href="queryoutput?type=3&start="+start+"&end="+end;
		}
		if($.trim(userid)!=""&&start!=""&&end!=""){
			window.self.location.href="queryoutput?type=5&userid="+userid+"&start="+start+"&end="+end;
		}
