...
<!-- content start -->
    ...
    <ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list ">
      <li><a href="cplist" class="am-text-success"><span class="am-icon-btn am-icon-file-text"></span><br/>接入CP<br/><%
      List cplist=(List)jdbcTemplate.queryForList("select * from cp_user where cp_id!=1");
      out.print(cplist.size()+"家");
       %></a></li>
    
    <li><a href="cplist?type=0" class="am-text-success"><span class="am-icon-btn am-icon-file-text"></span><br/>未审CP<br/><%
      List cplist2=(List)jdbcTemplate.queryForList("select * from cp_user where cp_id!=1 and verify_status=0");
      out.print(cplist2.size()+"家");
       %></a></li>
    
      <li><a href="prolist" class="am-text-warning"><span class="am-icon-btn am-icon-briefcase"></span><br/>接入产品<br/>
      <%List pro=(List)jdbcTemplate.queryForList("select * from product_info");
      out.print(pro.size()+"个"); %>
      </a></li>
      
      <li><a href="prolist?type=0" class="am-text-warning"><span class="am-icon-btn am-icon-briefcase"></span><br/>未审产品<br/>
      <%List pro2=(List)jdbcTemplate.queryForList("select * from product_info where verify_status=0");
      out.print(pro2.size()+"个"); %>
      </a></li>
    </ul>
    
    <ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list ">
    <li><a href="queryorder" class="am-text-danger"><span class="am-icon-btn am-icon-recycle"></span><br/>话单<br/>
      <%List output=(List)jdbcTemplate.queryForList("select * from user_order");
      out.print(output.size()+"条");
       %>
      </a></li>
    
      <li><a href="queryoutput" class="am-text-danger"><span class="am-icon-btn am-icon-recycle"></span><br/>详单<br/>
      <%List output2=(List)jdbcTemplate.queryForList("select * from output_list");
      out.print(output2.size()+"条");
       %>
      </a></li>
