...
%>
  ...
  <script>
	...
	function query(){
		window.self.location.href="queryoutput?type=2&linkid="+$("#linkid").val();
	}
</script>
</head>
<body>
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">按LinkID查询</strong> / <small>outPut List</small></div>
    </div>
    ...
    <div class="am-g">
      ...
      <input type="text" id="linkid" name="linkid" maxlength="10"/>
